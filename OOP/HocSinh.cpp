...
class hoc_sinh {
    ...
    public:
        ...
        friend bool operator <= (hoc_sinh a, hoc_sinh b);
        friend bool operator == (hoc_sinh a, hoc_sinh b);
        void operator = (const hoc_sinh &hs);     // hoc_sinh operator = (const hoc_sinh &hs);
        void Nhap();
        void Xuat();
        string getHo_Ten();
        float getDiem_Toan();
...
void hoc_sinh::operator = (const hoc_sinh &hs)             // hoc_sinh hoc_sinh::operator = (const hoc_sinh &hs)
{                                                          // {
    ho_ten = hs.ho_ten;                                    //      return *this;
